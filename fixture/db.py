    ...
    def get_contact_list(self):
        ...
        try:
            ...
            for row in cursor:
                ...
                list.append(Contact(id=str(id), lastname=lastname,firstname = firstname, address=address,email=email, email2=email2, email3=email3, homephone=home,workphone=work,
                       mobilephone=mobile, secondaryphone= phone2))
        finally:
            cursor.close()
        return list
